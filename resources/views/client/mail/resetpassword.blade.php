        ...
        <table border="0" cellpadding="0" cellspacing="0" class="heading_block block-8" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
            <tr>
                <td class="pad" style="text-align:center;width:100%;">
                    <h1 style="margin: 0; color: #ffffff; direction: ltr; font-family: 'Shrikhand', Impact, Charcoal, sans-serif; font-size: 38px; font-weight: normal; letter-spacing: 2px; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">Gửi lại mật khẩu cho khách hàng</span></h1>
                </td>
            </tr>
        </table>
            ...
            <tr>
                <td class="pad">
                    <div align="center" class="alignment">
                        <a href="{{env('APP_LINK_EAMIL').'/reset-password/'.$user->token.'/'.$user->id}}" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#feac04;border-radius:4px;width:auto;border-top:2px solid #FFFFFF;border-right:2px solid #FFFFFF;border-bottom:2px solid #FFFFFF;border-left:2px solid #FFFFFF;padding-top:10px;padding-bottom:10px;font-family:Varela Round, Trebuchet MS, Helvetica, sans-serif;font-size:18px;text-align:center;mso-border-alt:none;word-break:keep-all;"       
