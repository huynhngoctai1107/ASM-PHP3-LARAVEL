...
{{--                <ul class="nav ">--}}
{{--                    <li class="nav-item">--}}
{{--                        <a href="/admin/add-category-post" class="nav-link">--}}
{{--                            <i class="far fa-circle nav-icon"></i>--}}
{{--                            <p>Thêm loại bài viết</p>--}}
{{--                        </a>--}}
{{--                    </li>--}}
{{--                    <li class="nav-item">--}}
{{--                        <a href="/admin/add-category-product" class="nav-link">--}}
{{--                            <i class="far fa-circle nav-icon"></i>--}}
...
{{--                </ul>--}}
                <ul class="nav ">
                    <li class="nav-item">
                        <a href="/admin/list-categories-post" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="/admin/list-categories-product" class="nav-link">
